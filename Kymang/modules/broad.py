...
async def list_sellers(c, m):
    ...
    for user_id in sellers:
        try:
            ...
            seller_list.append(f"• {user_mention} (ID: {user_id})")  # Menggunakan mention dan ID
        except Exception as e:
            seller_list.append(f"• {user_mention} (ID: {user_id})")  # Menangani kesalahan jika pengguna tidak ditemukan
